            ...
            steps {
                script {
                    if (params.SYSTEM_UNDER_TEST == 'standalone') {
                        ...
                        build job: 'build-docker', parameters: [string(name: 'STANDALONE', value: ''), string(name: 'NFVO', value: 'refs/heads/' + params.BRANCH), string(name: 'VNFM_GENERIC', value: 'refs/heads/' + params.BRANCH), string(name: 'VNFM_DOCKER_GO', value: 'refs/heads/' + params.BRANCH), string(name: 'PLUGIN_VIMDRIVER_DOCKER', value: 'refs/heads/' + params.BRANCH), string(name: 'VNFM_DUMMY_AMQP', value: 'refs/heads/' + params.BRANCH), string(name: 'PLUGIN_VIMDRIVER_TEST', value: 'refs/heads/' + params.BRANCH), string(name: 'PLUGIN_VIMDRIVER_OPENSTACK', value: 'refs/heads/' + params.BRANCH), string(name: 'INTEGRATION_TESTS', value: 'refs/heads/' + params.BRANCH)]
                    }
                }
            }
        }
